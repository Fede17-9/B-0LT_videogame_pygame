<<<<<<< HEAD
"""
Módulo que define la clase MenuInicio para la interfaz inicial del juego.
Utiliza pygame-menu para gestionar botones y permite ver los controles.
"""
...
class MenuInicio:
    """
    Gestiona la pantalla de inicio, música de fondo y navegación del menú.
    """

    def __init__(self, screen):
        """
        Inicializa el menú de inicio y carga los recursos necesarios.
        ...
        if os.path.exists(path_musica):
            ...
            # Volumen al 40% (ideal para piano)
        ...
        for i in range(1, 5):
            ...
            if os.path.exists(path):
                ...
                img_escalada = pygame.transform.scale(
                    img, (self.screen.get_width(), self.screen.get_height()))
        ...
        if os.path.exists(path_controles):
            try:
                ...
                self.img_controles = pygame.transform.scale(
                    self.img_controles,
        ...
        self.tema.widget_selection_effect = (
        ...
        self.menu = pygame_menu.Menu(
            '', screen.get_width(), screen.get_height(), theme=self.tema)
    ...
    def _iniciar_juego(self):
        """
        Finaliza el menú y desvanece la música para iniciar el juego.
        """
        # Efecto de desvanecimiento de la música (1.5 segundos)
        pygame.mixer.music.fadeout(1500)
        self.activo = False

    def _ver_controles(self):
        """
        Activa la vista de la imagen de controles.
        """
        self.mostrando_controles = True

    def ejecutar(self):
        """
        Bucle principal del menú para procesar eventos y renderizado.
        """
